...
class DrugResponseModel(Genotype2PhenotypeTransformer):
    ...
    def get_sys_effect(self, genotype, transformer):
        ...
        if len(sys_indices) == 0:
            return None, None
        batch_size, sys_length = sys_indices.size()
        ...
        mask = genotype['mask']
        #print(mask.sum())
        snp_effect_from_embedding = transformer(sys_embedding, gene_embedding, mask)
        return sys_indices, snp_effect_from_embedding
