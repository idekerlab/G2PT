# Notice on Sample Data

All files in the `samples/` directory contain fully synthetic data generated solely for demonstration and testing purposes.

These sample files do **not** contain real UK Biobank participant-level data, real genotypes, real phenotypes, or real derived genetic data.
